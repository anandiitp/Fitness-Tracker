...
# Load data
# --------------------------------------------------------------
df=pd.read_pickle("../../data/interim/02_outliers_removed_chauenets.pkl")
...
fs=1000/200
cutoff=1.3
# higher the cutoff more raw 
#lower cutoff means smoother graph
...
subset[["acc_y", "acc_y_temp_mean_ws_50", "acc_y_temp_std_ws_50"]].plot()
subset[["gyr_y", "gyr_y_temp_mean_ws_50", "gyr_y_temp_std_ws_50"]].plot()
